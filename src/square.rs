...
mod ffi_conversion {
    use super::*;
    use crate::{FileFfi, ParseSquareErrorFfi, RankFfi, SquareFfi};
    ...
    impl From<FileFfi> for File {
        fn from(x: FileFfi) -> Self {
            match x {
                <FileFfi>::A => Self::A,
                <FileFfi>::B => Self::B,
                <FileFfi>::C => Self::C,
    ...
    impl From<RankFfi> for Rank {
        fn from(x: RankFfi) -> Self {
            match x {
                <RankFfi>::First => Self::First,
                <RankFfi>::Second => Self::Second,
                <RankFfi>::Third => Self::Third,
                <RankFfi>::Fourth => Self::Fourth,
                <RankFfi>::Fifth => Self::Fifth,
                <RankFfi>::Sixth => Self::Sixth,
                <RankFfi>::Seventh => Self::Seventh,
                <RankFfi>::Eighth => Self::Eighth,
                _ => unreachable!("No variant left"),
            }
        }
    }
    impl From<ParseSquareError> for ParseSquareErrorFfi {
        fn from(x: ParseSquareError) -> Self {
            Self.into()
        }
    }
    impl From<ParseSquareErrorFfi> for ParseSquareError {
        fn from(x: ParseSquareErrorFfi) -> Self {
            Self.into()
        }
    }
    impl From<Square> for SquareFfi {
        fn from(x: Square) -> Self {
            match x {
                <Square>::A1 => Self::A1,
                <Square>::B1 => Self::B1,
                <Square>::C1 => Self::C1,
    ...
    impl From<SquareFfi> for Square {
        fn from(x: SquareFfi) -> Self {
            match x {
                <SquareFfi>::A1 => Self::A1,
                <SquareFfi>::B1 => Self::B1,
                <SquareFfi>::C1 => Self::C1,
                <SquareFfi>::D1 => Self::D1,
                <SquareFfi>::E1 => Self::E1,
                <SquareFfi>::F1 => Self::F1,
                <SquareFfi>::G1 => Self::G1,
                <SquareFfi>::H1 => Self::H1,
                <SquareFfi>::A2 => Self::A2,
                <SquareFfi>::B2 => Self::B2,
                <SquareFfi>::C2 => Self::C2,
                <SquareFfi>::D2 => Self::D2,
                <SquareFfi>::E2 => Self::E2,
                <SquareFfi>::F2 => Self::F2,
                <SquareFfi>::G2 => Self::G2,
                <SquareFfi>::H2 => Self::H2,
                <SquareFfi>::A3 => Self::A3,
                <SquareFfi>::B3 => Self::B3,
                <SquareFfi>::C3 => Self::C3,
                <SquareFfi>::D3 => Self::D3,
                <SquareFfi>::E3 => Self::E3,
                <SquareFfi>::F3 => Self::F3,
                <SquareFfi>::G3 => Self::G3,
                <SquareFfi>::H3 => Self::H3,
                <SquareFfi>::A4 => Self::A4,
                <SquareFfi>::B4 => Self::B4,
                <SquareFfi>::C4 => Self::C4,
                <SquareFfi>::D4 => Self::D4,
                <SquareFfi>::E4 => Self::E4,
                <SquareFfi>::F4 => Self::F4,
                <SquareFfi>::G4 => Self::G4,
                <SquareFfi>::H4 => Self::H4,
                <SquareFfi>::A5 => Self::A5,
                <SquareFfi>::B5 => Self::B5,
                <SquareFfi>::C5 => Self::C5,
                <SquareFfi>::D5 => Self::D5,
                <SquareFfi>::E5 => Self::E5,
                <SquareFfi>::F5 => Self::F5,
                <SquareFfi>::G5 => Self::G5,
                <SquareFfi>::H5 => Self::H5,
                <SquareFfi>::A6 => Self::A6,
                <SquareFfi>::B6 => Self::B6,
                <SquareFfi>::C6 => Self::C6,
                <SquareFfi>::D6 => Self::D6,
                <SquareFfi>::E6 => Self::E6,
                <SquareFfi>::F6 => Self::F6,
                <SquareFfi>::G6 => Self::G6,
                <SquareFfi>::H6 => Self::H6,
                <SquareFfi>::A7 => Self::A7,
                <SquareFfi>::B7 => Self::B7,
                <SquareFfi>::C7 => Self::C7,
                <SquareFfi>::D7 => Self::D7,
                <SquareFfi>::E7 => Self::E7,
                <SquareFfi>::F7 => Self::F7,
                <SquareFfi>::G7 => Self::G7,
                <SquareFfi>::H7 => Self::H7,
                <SquareFfi>::A8 => Self::A8,
                <SquareFfi>::B8 => Self::B8,
                <SquareFfi>::C8 => Self::C8,
                <SquareFfi>::D8 => Self::D8,
                <SquareFfi>::E8 => Self::E8,
                <SquareFfi>::F8 => Self::F8,
                <SquareFfi>::G8 => Self::G8,
                <SquareFfi>::H8 => Self::H8,
                _ => unreachable!("No variant left"),
            }
        }
    }
