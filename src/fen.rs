#![doc = " Parse and write Forsyth-Edwards-Notation."]
#![doc = ""]
#![doc = " # Parsing"]
#![doc = ""]
#![doc = " The parser is relaxed:"]
#![doc = ""]
#![doc = " * Supports X-FEN and Shredder-FEN for castling right notation."]
#![doc = "   - Ignores repeated castling rights."]
#![doc = "   - Allows castling rights in any order."]
#![doc = "   - Allows castling rights without matching rooks (treating `Q` and `K` as"]
#![doc = "     `A` and `H` respectively)."]
#![doc = " * Supports `[q]` and `/q` styles for Crazyhouse pockets."]
#![doc = " * Supports `3+3` and `+0+0` for remaining checks in Three-Check."]
#![doc = " * Accepts missing FEN fields (except the board) and fills them with"]
#![doc = "   default values of `8/8/8/8/8/8/8/8 w - - 0 1`."]
#![doc = " * Accepts multiple spaces and underscores (`_`) as separators between"]
#![doc = "   FEN fields."]
#![doc = " * Accepts `0` as fulllmove number and uses `1` instead."]
#![doc = ""]
#![doc = " [`Fen`] and [`Epd`] implement [`FromStr`]:"]
#![doc = ""]
#![doc = " ```"]
#![doc = " use shakmaty::{fen::Fen, CastlingMode, Chess, Position};"]
#![doc = ""]
#![doc = " let fen: Fen = \"r1bqkbnr/ppp2Qpp/2np4/4p3/2B1P3/8/PPPP1PPP/RNB1K1NR b KQkq - 0 4\".parse()?;"]
#![doc = " let pos: Chess = fen.into_position(CastlingMode::Standard)?;"]
#![doc = " assert!(pos.is_checkmate());"]
#![doc = ""]
#![doc = " # use shakmaty::{fen::ParseFenError, PositionError};"]
#![doc = " # #[derive(Debug)] struct CommonError;"]
#![doc = " # impl From<ParseFenError> for CommonError { fn from(_: ParseFenError) -> Self { Self } }"]
#![doc = " # impl<P> From<PositionError<P>> for CommonError { fn from(_: PositionError<P>) -> Self { Self } }"]
#![doc = " # Ok::<_, CommonError>(())"]
#![doc = " ```"]
#![doc = ""]
#![doc = " # Writing"]
#![doc = ""]
#![doc = " Writes X-FEN with `[q]` style for Crazyhouse pockets and `3+3` style"]
#![doc = " for remainig checks in Three-Check."]
#![doc = ""]
#![doc = " [`Fen`] and [`Epd`] implement [`Display`]:"]
#![doc = ""]
#![doc = " ```"]
#![doc = " use shakmaty::{fen::Epd, EnPassantMode, Chess, Position};"]
#![doc = ""]
#![doc = " let pos = Chess::default();"]
#![doc = ""]
#![doc = " assert_eq!(Epd::from_position(pos, EnPassantMode::Legal).to_string(),"]
#![doc = "            \"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -\");"]
#![doc = " ```"]
use crate::{
...
#[doc = " Errors that can occur when parsing a FEN."]
...
fn parse_remaining_checks(s: &[u8]) -> Option<ByColor<RemainingChecks>> {
    ...
    Some(match (split.next(), split.next(), split.next()) {
        (Some(b""), Some(white_given), Some(black_given)) => ByColor {
        ...
        (Some(white), Some(black), None) => ByColor {
...
impl Board {
    ...
    #[doc = " Create a board FEN such as"]
    #[doc = " `rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR`."]
    #[doc = ""]
    #[doc = " Promoted pieces are marked like `Q~`."]
    #[doc = ""]
    #[doc = " Returns a [`BoardFen`] which implements [`Display`]."]
...
#[doc = " Displays a board with notation like"]
#[doc = " `rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR`."]
#[doc = ""]
#[doc = " See [`Board::board_fen`]."]
#[derive(Debug)]
#[repr(C)]
...
#[doc = " A FEN like `rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1`."]
#[derive(Clone, Eq, PartialEq, Hash, Debug, Default)]
#[repr(C)]
pub struct Fen(pub Setup);
impl Fen {
    #[doc = " The FEN of the empty position `8/8/8/8/8/8/8/8 w - - 0 1`."]
    pub const fn empty() -> Fen {
        Fen(Setup::empty())
    }
    #[doc = " Parses a FEN or EPD."]
    #[doc = ""]
    #[doc = " FENs consist of parts separated by spaces. This parser also accepts"]
    #[doc = " parts separated by underscores. Missing parts are filled with defaults."]
    #[doc = ""]
    #[doc = " # Errors"]
    #[doc = ""]
    #[doc = " Returns [`ParseFenError`] if any part is syntactically invalid."]
    #[doc = ""]
    #[doc = " # Example"]
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use shakmaty::fen::Fen;"]
    #[doc = ""]
    #[doc = " let fen = Fen::from_ascii(b\"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1\")?;"]
    #[doc = " assert_eq!(fen, Fen::default());"]
    #[doc = " # Ok::<_, shakmaty::fen::ParseFenError>(())"]
    #[doc = " ```"]
    ...
    #[doc = " Set up a [`Position`]. See [`FromSetup`]."]
    #[doc = ""]
    #[doc = " # Errors"]
    #[doc = ""]
    #[doc = " Returns [`PositionError`] if the setup does not meet basic validity"]
    #[doc = " requirements."]
...
#[doc = " An EPD like `rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -`."]
#[derive(Clone, Eq, PartialEq, Hash, Debug, Default)]
#[repr(C)]
...
mod tests {
    ...
    fn test_invalid_fen() {
        ...
        assert_eq!(
            "8/8/8/8/8/8/8/8 w · - 0 1".parse::<Fen>().unwrap_err(),
        ...
        assert_eq!(
            "4k2r/8/8/8/8/8/8/RR2K2R w KBQk - 0 1"
                .parse::<Fen>()
                .unwrap_err(),
            ParseFenError::InvalidCastling
        );
...
#[no_mangle]
pub extern "C" fn ffi_board_from_ascii_board_fen(board_fen: &[u8]) -> Result<Board, ParseFenError> {
    <Board>::from_ascii_board_fen(board_fen)
}
#[no_mangle]
pub const extern "C" fn ffi_fen_from_setup(setup: Setup) -> Fen {
    <Fen>::from_setup(setup)
}
#[no_mangle]
pub extern "C" fn ffi_fen_from_position<P: Position>(pos: P, mode: EnPassantMode) -> Fen {
    <Fen>::from_position(pos, mode)
}
#[no_mangle]
pub const extern "C" fn ffi_fen_as_setup(self_: &Fen) -> &Setup {
    <Fen>::as_setup(self_)
}
#[no_mangle]
pub const extern "C" fn ffi_fen_into_setup(self_: Fen) -> Setup {
    <Fen>::into_setup(self_)
}
#[no_mangle]
pub const extern "C" fn ffi_epd_empty() -> Epd {
    <Epd>::empty()
}
#[no_mangle]
pub extern "C" fn ffi_epd_from_ascii(epd: &[u8]) -> Result<Epd, ParseFenError> {
    <Epd>::from_ascii(epd)
}
#[no_mangle]
pub const extern "C" fn ffi_epd_from_setup(mut setup: Setup) -> Epd {
    <Epd>::from_setup(setup)
}
#[no_mangle]
pub extern "C" fn ffi_epd_from_position<P: Position>(pos: P, mode: EnPassantMode) -> Epd {
    <Epd>::from_position(pos, mode)
}
#[no_mangle]
pub const extern "C" fn ffi_epd_as_setup(self_: &Epd) -> &Setup {
    <Epd>::as_setup(self_)
}
#[no_mangle]
pub const extern "C" fn ffi_epd_into_setup(self_: Epd) -> Setup {
    <Epd>::into_setup(self_)
}
#[no_mangle]
pub extern "C" fn ffi_epd_into_position<P: FromSetup>(
    self_: Epd,
    mode: CastlingMode,
) -> Result<P, PositionError<P>> {
    <Epd>::into_position(self_, mode)
}
