#![doc = " Piece positions on a board."]
...
#[doc = ""]
#[doc = " ```"]
#[doc = " use shakmaty::{Square, Board, Color::Black};"]
#[doc = ""]
#[doc = " let board = Board::new();"]
#[doc = " // r n b q k b n r"]
#[doc = " // p p p p p p p p"]
#[doc = " // . . . . . . . ."]
#[doc = " // . . . . . . . ."]
...
#[doc = " // R N B Q K B N R"]
#[doc = ""]
#[doc = " assert_eq!(board.piece_at(Square::E8), Some(Black.king()));"]
#[doc = " ```"]
...
impl Board {
    ...
    #[doc = " Creates a board from bitboard constituents."]
    #[doc = ""]
    #[doc = " # Panics"]
    #[doc = ""]
    #[doc = " Panics if the bitboards are inconsistent."]
    ...
    #[doc = " The (unique!) king of the given side, if any."]
    #[inline]
    ...
    #[doc = " Mirror the board vertically. See [`Bitboard::flip_vertical`]."]
    pub fn flip_vertical(&mut self) {
        self.transform(Bitboard::flip_vertical);
    }
    #[doc = " Mirror the board horizontally. See [`Bitboard::flip_horizontal`]."]
    pub fn flip_horizontal(&mut self) {
        self.transform(Bitboard::flip_horizontal);
    }
    #[doc = " Mirror the board at the a1-h8 diagonal."]
    #[doc = " See [`Bitboard::flip_diagonal`]."]
    pub fn flip_diagonal(&mut self) {
        self.transform(Bitboard::flip_diagonal);
    }
    #[doc = " Mirror the board at the h1-a8 diagonal."]
    #[doc = " See [`Bitboard::flip_anti_diagonal`]."]
    pub fn flip_anti_diagonal(&mut self) {
        self.transform(Bitboard::flip_anti_diagonal);
    }
    #[doc = " Rotate the board 90 degrees clockwise. See [`Bitboard::rotate_90`]."]
    pub fn rotate_90(&mut self) {
        self.transform(Bitboard::rotate_90);
    }
    #[doc = " Rotate the board 180 degrees. See [`Bitboard::rotate_180`]."]
    pub fn rotate_180(&mut self) {
        self.transform(Bitboard::rotate_180);
    }
    #[doc = " Rotate the board 270 degrees clockwise. See [`Bitboard::rotate_270`]."]
...
#[doc = " Iterator over the pieces of a [`Board`]."]
#[derive(Clone, Eq, PartialEq, Hash)]
#[repr(C)]
pub struct IntoIter {
    inner: Board,
...
#[no_mangle]
pub const extern "C" fn ffi_board_new() -> Board {
    <Board>::new()
}
#[no_mangle]
pub const extern "C" fn ffi_board_empty() -> Board {
    <Board>::empty()
}
#[no_mangle]
pub const extern "C" fn ffi_board_into_bitboards(
    self_: Board,
) -> (ByRole<Bitboard>, ByColor<Bitboard>) {
    <Board>::into_bitboards(self_)
}
#[no_mangle]
pub extern "C" fn ffi_board_attacks_from(self_: &Board, sq: Square) -> Bitboard {
    <Board>::attacks_from(self_, sq)
}
#[no_mangle]
pub extern "C" fn ffi_board_material_side(self_: &Board, color: Color) -> ByRole<u8> {
    <Board>::material_side(self_, color)
}
#[no_mangle]
pub extern "C" fn ffi_board_material(self_: &Board) -> ByColor<ByRole<u8>> {
    <Board>::material(self_)
}
#[no_mangle]
pub extern "C" fn ffi_board_pop_front(self_: &mut Board) -> Option<(Square, Piece)> {
    <Board>::pop_front(self_)
}
#[no_mangle]
pub extern "C" fn ffi_board_pop_back(self_: &mut Board) -> Option<(Square, Piece)> {
    <Board>::pop_back(self_)
}
